import { EElementType, IFocusedElement, IOptionAttributes, TElementMap } from "src/context-providers";
...
export declare const validateOptions: (options: IOptionAttributes[], context: yup.TestContext<yup.AnyObject>) => boolean;
