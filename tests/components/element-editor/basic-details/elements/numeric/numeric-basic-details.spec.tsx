...
import { NumericBasicDetails } from "src/components";
import {
    EElementType,
        ...
        it.each(attributeFields)(
            ...
            async (fieldName) => {
                renderComponent({
                    ...
                    builderContext: {
                        focusedElement: {
                            element: MOCK_FOCUSED_NUMERIC_ELEMENT,
                            isDirty: false,
                        },
...
const renderComponent = (overrideOptions?: TestHelper.RenderOptions) => {
    return render(
        TestHelper.withProviders(overrideOptions, <NumericBasicDetails />)
    );
};

const MOCK_FOCUSED_NUMERIC_ELEMENT: TElement = {
    internalId: "mock123",
