...
export declare const ElementName: import("styled-components").StyledComponent<"p", any, import("@lifesg/react-design-system/typography").TypographyProps, never>;
export declare const IdLabel: import("styled-components").StyledComponent<"p", any, import("@lifesg/react-design-system/typography").TypographyProps, never>;
...
export declare const DroppableText: import("styled-components").StyledComponent<"p", any, import("@lifesg/react-design-system/typography").TypographyProps, never>;
export declare const ElementBaseCard: import("styled-components").StyledComponent<({ id, children, focused, onClick, className, }: IProps) => import("react/jsx-runtime").JSX.Element, any, IElementCardProps, never>;
