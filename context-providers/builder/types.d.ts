...
export declare enum EBuilderMode {
...
export declare enum ETextFieldMode {
...
export type TBuilderAction = ITogglePanelAction | IUpdateOrderedIdentifiersAction | IToggleModeAction | IAddElementAction | IDeleteElementAction | IUndoDeleteElementAction | IFocusElementAction | IRemoveFocusedElementAction | IUpdateElementAction | IUpdateFocusedElementAction | ISelectElementTypeAction | IToggleSubmittingAction | IUpdateSchemaElementAction;
