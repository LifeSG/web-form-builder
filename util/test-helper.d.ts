...
export declare namespace TestHelper {
    ...
    const withProviders: ({ configContext, builderContext, displayContext, formContext, includeFormProvider, }: RenderOptions, component: React.ReactNode) => import("react/jsx-runtime").JSX.Element;
}
export {};
